...
PROGRAMS = [
    ...
    {"jenjang":"SMA", "kelas":"10–11", "mapel":["Matematika","Fisika","Kimia"], "deskripsi":"Pendalaman konsep, pemecahan masalah, dan persiapan evaluasi untuk kelas 10 sampai 11."},
]
DEFAULT_SCHEDULES = [
...
def allowed_subjects(jenjang, kelas):
    ...
    rules = {
        ...
        "SMA": ({"10", "11"}, {"Matematika", "Fisika", "Kimia"}),
    }
